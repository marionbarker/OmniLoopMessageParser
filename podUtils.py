...
def getActionDict():
    # this is the list of messages that should be paired
    # actionDict { 'actionName' : (idx into name list ('sendName', 'recvName')}
    ...
    #   frame before the next search (see checkAction)
